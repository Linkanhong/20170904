...
$(document).ready(function(){
	//动态添加大转盘的奖品与奖品区域背景颜色
	// 中奖概率
	turnplate.randomRate = ["0%", '0%', '100%', '0%', '0%', '0%', '0%', '0%', '0%', '0%'];
...
// 中奖名单轮播
function go(){
	var size=$(".winners-list>li").length-5;
	var winHeight=$(".winners-list>li").height();
	var num=0;
	setInterval(function(){
		...
		$(".winners-list").animate({top: -num*winHeight+'px'});
	},2000)
}
go();
